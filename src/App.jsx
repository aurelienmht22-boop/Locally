...
async function downloadHotelPoster(slug, qrUrl){
  ...
  const qrSize=Math.round(169*canvas.width/864*0.8892);
  const qrX=canvas.width-qrSize-Math.round(canvas.width*0.0675);
  const qrY=Math.round(966*canvas.height/1222);
